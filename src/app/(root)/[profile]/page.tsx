...
export default async function ProfilePage({ params }: { params: { profile: string } }) {
  ...
  return (
    <main className="container mx-auto p-6 space-y-8 w-full">
      <section className="flex flex-col items-center space-y-4">
        ...
        <p className="text-gray-500 max-w-xs text-center">
          Short bio about the user which can span multiple lines and is center aligned for better readability.
        </p>
      </section>
      <section className="space-y-4 max-w-[40%] mx-auto">
