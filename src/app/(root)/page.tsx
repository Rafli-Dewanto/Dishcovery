...
export default function Home() {
  return (
    <main className="relative grid min-h-screen w-full grid-cols-1 overflow-hidden px-[2rem] pt-[6rem] md:pb-32">
      {/* Hero section */}
      <section className="flex flex-col gap-x-8 sm:flex-row">
            ...
            <Card className="relative grid min-h-[25rem] grid-cols-1 items-center justify-items-center">
              <CardHeader>
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <CardContent>
                    <p>
                      Craft your own unique recipes, share your culinary
                      creations, and contribute to the community with your
                      cooking expertise.
                    </p>
                  </CardContent>
                </div>
            ...
            <Card className="relative grid min-h-[25rem] grid-cols-1 items-center justify-items-center">
              <CardHeader>
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <CardContent>
                    <p>
                      Follow step-by-step guides, prepare delightful dishes, and
                      savor the joy of cooking and relishing delicious homemade
                      meals.
                    </p>
                  </CardContent>
                </div>
